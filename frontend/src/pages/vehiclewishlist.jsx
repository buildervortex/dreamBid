  ...
  const cars = [
    {
      id: 1,
      name: 'Toyota Prius',
      description: 'Hybrid Synergy Drive, Impressive Fuel Economy, Primarily City-Driven',
      price: '$41,500',
    ...
    },
    {
      id: 2,
      name: 'Toyota Prius',
      description: '4-Cylinder Hybrid, Eco-Friendly Upgrades, Well-Maintained by One Owner',
      price: '$36,000',
    ...
    },
    {
      id: 3,
      name: 'Toyota Corolla',
      description: 'Reliable 4-Cylinder Engine, Smooth Handling, Mostly Highway Miles',
      price: '$50,500',
    ...
    <div className="flex flex-col w-full min-h-screen p-8 ">
      ...
      <header className="flex items-center justify-between mb-2">
        ...
        <div className="flex justify-end w-1/4 ml-auto ">
          ...
          <h4 className="text-2xl font-semibold text-purple-900">Results: {cars.length} </h4>
        </div>
      </header>
